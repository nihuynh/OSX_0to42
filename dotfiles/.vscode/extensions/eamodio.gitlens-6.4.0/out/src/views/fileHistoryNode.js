    ...
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (status !== undefined && (status.indexStatus !== undefined || status.workTreeStatus !== undefined)) {
                ...
                const commit = new gitService_1.GitLogCommit(gitService_1.GitCommitType.File, this.uri.repoPath, sha, 'You', new Date(), '', status.fileName, [status], status.status, status.originalFileName, previousSha, status.originalFileName || status.fileName);
