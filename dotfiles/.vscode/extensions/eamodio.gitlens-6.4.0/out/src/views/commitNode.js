    ...
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (commit === undefined)
                return [];
            let children = [
                ...system_1.Iterables.map(commit.fileStatuses, s => new commitFileNode_1.CommitFileNode(s, commit.toFileCommit(s), this.explorer, commitFileNode_1.CommitFileNodeDisplayAs.File, this.branch))
            ];
