...
class Git {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                tmp.file({ prefix: `${path.basename(fileName, ext)}-${suffix}__`, postfix: ext }, (err, destination, fd, cleanupCallback) => {
                    ...
                    logger_1.Logger.log(`getVersionedFile[${destination}]('${repoPath}', '${fileName}', ${branchOrSha})`);
    ...
    static log_resolve(repoPath, sha, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield gitCommand({ cwd: repoPath, willHandleErrors: true }, `log`, `--full-history`, `-M`, `-n1`, `--no-merges`, `--format=%H`, sha, `--`, fileName);
                return data.trim();
            }
            catch (_a) {
                return undefined;
    ...
    static revparse(repoPath, ref) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield gitCommand({ cwd: repoPath, willHandleErrors: true }, `rev-parse`, ref);
                return data.trim();
            }
            catch (ex) {
                return undefined;
