...
class GitBlameParser {
    ...
    static parseEntry(entry, repoPath, fileName, commits, authors, lines) {
        ...
        if (commit === undefined) {
            ...
            commit = new git_1.GitBlameCommit(repoPath, entry.sha, entry.author, new Date(entry.authorDate * 1000), entry.summary, fileName, fileName !== entry.fileName ? entry.fileName : undefined, entry.previousSha, entry.previousSha && entry.previousFileName, []);
