...
class GitService extends vscode_1.Disposable {
    ...
    onConfigurationChanged(e) {
        ...
        if (initializing || configuration_1.configuration.changed(e, configuration_1.configuration.name('keymap').value)) {
            constants_1.setCommandContext(constants_1.CommandContext.KeyMap, cfg.keymap);
        }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return {
                    ...
                    commit: system_1.Iterables.first(blame.commits.values()),
    ...
    getLogCommit(repoPath, fileName, shaOrOptions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (commit === undefined && sha && !options.firstIfMissing) {
                if (!git_1.Git.isResolveRequired(sha))
                    return undefined;
            }
    ...
    getLogForFileCore(repoPath, fileName, sha, options, entry, key) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield this.isTracked(fileName, repoPath, sha))) {
    ...
    getVersionedFile(repoPath, fileName, sha) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const entry = new UriCacheEntry(new gitUri_1.GitUri(vscode_1.Uri.file(fileName), { sha: sha, repoPath: repoPath }));
    ...
    isTracked(fileNameOrUri, repoPath, sha) {
        return __awaiter(this, void 0, void 0, function* () {
            if (sha === GitService.deletedSha)
                return false;
            let cacheKey;
            let fileName;
    ...
    resolveReference(repoPath, sha, uri) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!GitService.isResolveRequired(sha))
                return sha;
            logger_1.Logger.log(`resolveReference('${repoPath}', '${sha}', '${uri && uri.toString()}')`);
            if (uri === undefined)
                return (yield git_1.Git.revparse(repoPath, sha)) || sha;
            return (yield git_1.Git.log_resolve(repoPath, sha, git_1.Git.normalizePath(path.relative(repoPath, uri.fsPath)))) || sha;
        });
    }
    ...
    static isResolveRequired(sha) {
        return git_1.Git.isResolveRequired(sha);
    }
    static isSha(sha) {
