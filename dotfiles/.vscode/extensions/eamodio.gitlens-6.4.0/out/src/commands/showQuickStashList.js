...
class ShowQuickStashListCommand extends common_1.ActiveEditorCachedCommand {
    ...
    execute(editor, uri, args = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const progressCancellation = quickPicks_1.StashListQuickPick.showProgress('list');
            try {
                ...
                const pick = yield quickPicks_1.StashListQuickPick.show(this.git, stash, 'list', progressCancellation, args.goBackCommand, currentCommand);
                if (pick === undefined)
                    return undefined;
                if (pick instanceof quickPicks_1.CommandQuickPickItem)
                    return pick.execute();
                return vscode_1.commands.executeCommand(common_1.Commands.ShowQuickCommitDetails, pick.commit.toGitUri(), {
                    commit: pick.commit,
                    sha: pick.commit.sha,
