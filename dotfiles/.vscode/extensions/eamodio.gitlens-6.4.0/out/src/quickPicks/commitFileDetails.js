...
class OpenCommitFileRevisionCommandQuickPickItem extends common_1.OpenFileCommandQuickPickItem {
    constructor(commit, item) {
        ...
        let uri;
        if (commit.status === 'D') {
            uri = gitService_1.GitUri.toRevisionUri(commit.previousFileSha, commit.previousUri.fsPath, commit.repoPath);
            ...
            uri = gitService_1.GitUri.toRevisionUri(commit.sha, commit.uri.fsPath, commit.repoPath);
...
class CommitFileDetailsQuickPick {
    static show(git, commit, uri, goBackCommand, currentCommand, fileLog) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (remotes.length) {
                if (commit.workingFileName && commit.status !== 'D') {
                    const branch = yield git.getBranch(commit.repoPath);
